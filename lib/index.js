...
(function() {
  var colors, dirIsValid, fontello, fs, needle, open, path, pjson, print, program, unzip;
  ...
  fontello = function() {
    ...
    program.command('open').description('open fontello website with config.').action(function(env, options) {
      var data, host;
      host = 'http://fontello.com';
      data = {
        config: {
